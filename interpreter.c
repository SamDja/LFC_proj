...
data eval_expr(node expr, symrec ** symTable,list * routineList){
  ...
  switch (expr.operator) {
    ...
    case IN:
    {
      ...
      if (e1.type == complex_dataType) {
        yyerror("increasing on complex data type is NOT_ALLOWED");
        exit(NOT_ALLOWED);
      }

      switch (e1.b.type)
      {
        case basic_int_value:b.type = e1.b.type; b.i = e1.b.i+1;break;
        case basic_float_value:b.type = e1.b.type; b.f = e1.b.f+1.0;break;
        case basic_boolean_value:
